module gold_miner::auto_miner {
    ...
    struct UpdateManualMinerCostEvent has copy, drop {
        new_cost: u64
    }

    struct UpdateHydroMinerCostEvent has copy, drop {
        new_cost: u64
    }

    struct UpdateElectricMinerCostEvent has copy, drop {
        new_cost: u64
    }

    struct UpdateManualMiningPowerEvent has copy, drop {
        new_power: u64
    }

    struct UpdateHydroMiningPowerEvent has copy, drop {
        new_power: u64
    }
    ...
    public fun update_manual_miner_cost(
        ...
        event::emit(UpdateManualMinerCostEvent { new_cost });
    }
    ...
    public fun update_hydro_miner_cost(
        ...
        event::emit(UpdateHydroMinerCostEvent { new_cost });
    }
    ...
    public fun update_electric_miner_cost(
        ...
        event::emit(UpdateElectricMinerCostEvent { new_cost });
    }
    ...
    public fun update_manual_mining_power(
        ...
        event::emit(UpdateManualMiningPowerEvent { new_power });
    }
    ...
    public fun update_hydro_mining_power(
        ...
        event::emit(UpdateHydroMiningPowerEvent { new_power });
    }
    ...
    public fun update_electric_mining_power(
        ...
        event::emit(UpdateElectricMiningPowerEvent { new_power });
    }
